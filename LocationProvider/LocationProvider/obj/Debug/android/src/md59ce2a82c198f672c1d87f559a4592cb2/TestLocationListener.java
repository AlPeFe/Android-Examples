package md59ce2a82c198f672c1d87f559a4592cb2;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LocationProvider.TestLocationListener, LocationProvider, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TestLocationListener.class, __md_methods);
	}


	public TestLocationListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == TestLocationListener.class)
			mono.android.TypeManager.Activate ("LocationProvider.TestLocationListener, LocationProvider, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
