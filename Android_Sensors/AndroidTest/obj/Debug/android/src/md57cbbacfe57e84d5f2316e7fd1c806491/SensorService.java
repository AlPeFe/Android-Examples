...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AndroidTest.SensorService, AndroidTest, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SensorService.class, __md_methods);
	}


	public SensorService () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SensorService.class)
			mono.android.TypeManager.Activate ("AndroidTest.SensorService, AndroidTest, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
