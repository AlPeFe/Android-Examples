package md5b6966692a0242d3f4e5a39c1db0f510f;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GamDroidUpgrade.BackgroundServices.LocationService, GamDroidUpgrade, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LocationService.class, __md_methods);
	}


	public LocationService () throws java.lang.Throwable
	{
		super ();
		if (getClass () == LocationService.class)
			mono.android.TypeManager.Activate ("GamDroidUpgrade.BackgroundServices.LocationService, GamDroidUpgrade, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
